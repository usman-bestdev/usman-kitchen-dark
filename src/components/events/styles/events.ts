...
export const cardBaseClasses = `${styles.cardBase}`;

export const imageOverlyClasses = `d-flex justify-content-between flex-column`;
...
export const cardDateClasses = `${styles.cardDate}`;

export const cardBaseContentClasses = `${styles.cardBaseContent}`;
